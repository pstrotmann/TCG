...
public class MitgliedManager 
{
	...
	public String UebernahmeAction() {
		this.erfNachricht = "Ãœbernahme der Daten erfolgreich";
		new MitgliederImporter().importiere();
		return "Uebernahme";
    }
	
	public String uebernahmeEmailAction() {
		this.erfNachricht = "Ãœbernahme der eMail-Adressen erfolgreich";
	...
	public String sendeAction() {
		...
		this.erfNachricht = "Mail wurde erfolgreich an "+ mailEmpfaengerListe.size() +" EmpfÃ¤nger versendet.";
		return "Erfolg";
    }
	...
	public String storeAction() {
		...
		if (this.mitglied.getIBAN().compareTo(" ") > 0) {
			...
			if (this.mitglied.getZahlungsart() > 1)
				...
				this.erfNachricht = "Lastschrift ohne Iban nicht möglich";
		}
		if (datOk && ibanOk) {
